...
import { ArrowLeft, Wine, Construction } from 'lucide-react';

export default function SimulateurSpiritueux() {
  return (
    <div className="pt-20">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <div className="flex items-center gap-3 mb-10">
              ...
              <div>
                <h1 className="font-heading text-2xl lg:text-3xl font-bold">Simulateur de Distillation</h1>
                <p className="text-sm text-muted-foreground">Simulation des étapes de distillation</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <p className="text-muted-foreground max-w-md">
              Le simulateur de distillation est en cours de construction. 
